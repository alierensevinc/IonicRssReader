...
@Component({
  selector: 'page-yasam',
  templateUrl: 'yasam.html',
})
export class YasamPage {

  newsItems: any;

  gundemNewsURL : String = 'https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fwww.ntv.com.tr%2Fyasam.rss';
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad YasamPage');
  }
