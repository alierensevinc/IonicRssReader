...
@Component({
  selector: 'page-spor',
  templateUrl: 'spor.html',
})
export class SporPage {

  newsItems: any;

  gundemNewsURL : String = 'https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fwww.ntv.com.tr%2Fspor.rss';
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SporPage');
    this.haberServiceProvider.getNews(this.gundemNewsURL);
    this.newsItems = this.haberServiceProvider.gundemNews;
  }
